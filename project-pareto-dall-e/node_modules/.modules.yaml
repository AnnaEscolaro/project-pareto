...
hoistedDependencies:
  ...
  /cosmiconfig/7.1.0:
    cosmiconfig: private
  /create-jest/29.7.0(@types/node@20.3.1)(ts-node@10.9.1):
    create-jest: private
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@20.3.1)(ts-node@10.9.1):
    jest-cli: private
  /jest-config/29.7.0(@types/node@20.3.1)(ts-node@10.9.1):
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Sat, 11 May 2024 13:43:51 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  - /fsevents/2.3.3
storeDir: /home/anna/.local/share/pnpm/store/v3
