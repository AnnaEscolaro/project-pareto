...
describe('ImagesController', () => {
  ...
  beforeEach(async () => {
    // Create a mock for the ImagesService
    ...
    const module: TestingModule = await Test.createTestingModule({
      controllers: [ImagesController],
      providers: [
        { provide: ImagesService, useValue: imagesServiceMock }, // Provide the mock implementation
      ],
    }).compile();
  ...
  describe('getAll', () => {
    it('should return images for a given userId', async () => {
      ...
      // Mock the findAll method of the service
  ...
  describe('generateImage', () => {
    it('should generate and return an image', async () => {
      ...
      // Mock the generateImage method of the service
